...
public class FavouriteActivity extends AppCompatActivity {
    ...
    public void display()
    {
        try {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse(Config.HOST+"favdisplay.php").newBuilder();
                            ...
                            try {
                                ...
                                myListViewForSongs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                        ...
                                        Intent intent=new Intent(getApplicationContext(),PlayerActivity1.class).putExtra("songs",mySongs).putExtra("songname",songName).putExtra("pos",i);
