        ...
        btn_fav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse(Config.HOST+"fav.php").newBuilder();
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    try {
                                        ...
                                        Log.e("message", s1);
                                        Toast.makeText(PlayerActivity2.this, "Added to favourites", Toast.LENGTH_SHORT).show();
