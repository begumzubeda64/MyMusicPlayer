...
public class ExistingPlaylist extends AppCompatActivity {
    ...
    public void display()
    {
        try {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse(Config.HOST+"existplay.php").newBuilder();
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                for (int i=0;i<jsonArray.length();i++)
                                {
                                    ...
                                    items[i]=jsonObject.getString("pname").replace(".mp3","");
                                    list1.add(new File(jsonObject.getString("pname")));
                                }
                                ...
                                myListViewForSongs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                        ...
                                        Intent intent=new Intent(ExistingPlaylist.this,SongList.class);
