...
public class MostPlayActivity extends AppCompatActivity {
    ...
    public void display()
    {
        try {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse(Config.HOST+"mostplayed.php").newBuilder();
                            ...
                            try {
                                ...
                                myListViewForSongs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                        ...
                                        Intent intent=new Intent(getApplicationContext(),PlayerActivity2.class).putExtra("songs",mySongs).putExtra("songname",songName).putExtra("pos",i);
