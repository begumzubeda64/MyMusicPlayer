        ...
        btn_fav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse(Config.HOST+"playdel.php").newBuilder();
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    try {
                                        ...
                                        Log.e("message", s1);
                                        Toast.makeText(PlayerActivity3.this, "Removed from playlist", Toast.LENGTH_SHORT).show();
                                        myMediaPlayer.stop();

                                        Intent intent=new Intent(PlayerActivity3.this,SongList1.class);
                                        intent.putExtra("songname",pn);
